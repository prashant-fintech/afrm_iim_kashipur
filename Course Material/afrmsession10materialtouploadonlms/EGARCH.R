...
spec1=ugarchspec(variance.model = list(model = "eGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "norm")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_EGARCH.csv")
...
library(rugarch)
#Specify a GARCH Model
spec1=ugarchspec(variance.model = list(model = "eGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "std")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_EGARCH_t.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
...
library(rugarch)
#Specify a GARCH Model
spec1=ugarchspec(variance.model = list(model = "eGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "ged")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_EGARCH_ged.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
#GED quantiles
...
library(rugarch)
#Specify a GARCH Model
spec1=ugarchspec(variance.model = list(model = "eGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "snorm")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_EGARCH_snorm.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
...
library(rugarch)
#Specify a GARCH Model
spec1=ugarchspec(variance.model = list(model = "eGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "sstd")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_EGARCH_st.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
...
library(rugarch)
#Specify a GARCH Model
spec1=ugarchspec(variance.model = list(model = "eGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "sged")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_EGARCH_sged.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
