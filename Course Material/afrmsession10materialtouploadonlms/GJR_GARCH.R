...
spec1=ugarchspec(variance.model = list(model = "gjrGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "norm")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_GJRGARCH.csv")
...
library(rugarch)
#Specify a GARCH Model
spec1=ugarchspec(variance.model = list(model = "gjrGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "std")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_GJRGARCH_t.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
...
library(rugarch)
#Specify a GARCH Model
spec1=ugarchspec(variance.model = list(model = "gjrGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "ged")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_GJRGARCH_ged.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
#GED quantiles
...
library(rugarch)
#Specify a GARCH Model
spec1=ugarchspec(variance.model = list(model = "gjrGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "snorm")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_GJRGARCH_snorm.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
...
library(rugarch)
#Specify a GARCH Model
spec1=ugarchspec(variance.model = list(model = "gjrGARCH", garchOrder = c(1, 1)),mean.model = list(armaOrder = c(0, 0),include.mean = FALSE),distribution.model = "sstd")
#Fit a GARCH model
garch_fit_1 = ugarchfit(spec = spec1, data = nifty)
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_GJRGARCH_st.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
...
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="reliance_vol_estimates_GJRGARCH_sged.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
