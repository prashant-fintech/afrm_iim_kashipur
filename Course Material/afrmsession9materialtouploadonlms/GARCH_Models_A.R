...
setwd("G:\\My Drive\\Asus\\Subjects_Preparation\\NuLearn\\AFRM\\Batch_12\\Sessions\\Session_9")
...
write.csv(sigma,file="vol_estimates_GARCH.csv")
...
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="vol_estimates_GARCH_t.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
...
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="vol_estimates_GARCH_ged.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
#GED quantiles
...
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="vol_estimates_GARCH_snorm.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
...
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="vol_estimates_GARCH_st.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
...
garch_fit_1
sigma=garch_fit_1@fit$sigma
write.csv(sigma,file="vol_estimates_GARCH_sged.csv")
for_c=ugarchforecast(garch_fit_1,n.ahead=1)
for_c1=for_c@forecast$sigmaFor[[1]]
for_c1
